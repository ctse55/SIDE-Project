...
const Healthcare = () => {
    ...
    const contractAddress = "0x5B38Da6a701c568545dCfcB03FcB875f56beddC4"; //address of the Meta Mask Wallet
    ...
    const authorizeProvider = async () => {
        if (isOwner) {
            try {
                ...
                console.error("Only contract owner can authroize different providers", error); 
            }
        } else {
    ...
    return(
        ...
        <div className='records-section'>
            ...
            {patientRecords.map((record, index) => (
                <div key = {index}>
                    <p>Record ID: {record.recordID.toNumbber()}</p>
